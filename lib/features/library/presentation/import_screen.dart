...
import 'kindle_webview_import.dart';
...
/// Launcher for Kindle WebView import
/// This just redirects to the WebView-based import screen
class KindleImportGuide extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Navigator.of(context).pushReplacement(
        MaterialPageRoute(
          builder: (context) => const KindleWebViewImport(),
        ),
      );
    });
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text('Opening Kindle...', style: AppTypography.bodyMedium),
          ],
        ),
      ),
    );
