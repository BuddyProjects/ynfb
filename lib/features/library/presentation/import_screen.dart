...
class AudibleImportGuide extends StatelessWidget {
  ...
  const AudibleImportGuide({super.key, required this.onUploadCsv});
...
class KindleImportGuide extends StatelessWidget {
  final VoidCallback onPasteJson;

  const KindleImportGuide({super.key, required this.onPasteJson});
...
class GoodreadsImportGuide extends StatelessWidget {
  final VoidCallback onUploadCsv;

  const GoodreadsImportGuide({super.key, required this.onUploadCsv});
